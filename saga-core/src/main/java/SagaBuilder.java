...
public class SagaBuilder {
     ...
     * @return A Node object representing the saga.
     */
     ...
     * creating a new Node for each action and linking it to the previous node. If the list of incompensable actions is null, it returns null.
     *
     * @param compensations The list of incompensable actions to be included in the graph.
     * @return A Node object representing the incompensable graph, or null if the input list is null.
     */
     ...
     * creating a new Node for each action. Each node is linked to the previous node (the uncompensable node or the last compensation node)
     * and to the next compensation node in case of failure.
     *
     * @param actions       The list of actions to be included in the graph.
     * @param uncompensableNode The Node representing the uncompensable graph.
     * @param compensationsNode The list of Node objects representing the compensation nodes.
     * @return A Node object representing the action graph.
     */
     ...
     * It iterates over the list of compensations, creating a new Node for each compensation and linking it to the last non-null node.
     *
     * @param compensations The list of compensations to be included in the list of nodes.
     * @return A list of Node objects representing the compensation nodes.
     */
